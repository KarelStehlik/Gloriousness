        ...
        () -> {
          var a = Ability.add("Assassin", 10000, () ->
                  """
                      ...
                      We are not driven by insanity, but by a true sense of righteousness that demands no accolades or recognition. We, the Ninjas, are the silent saviors of this doomed world, the only salvation to be found in our merciless blades. We cut down all who stand in our path, leaving nothing but devastation and carnage in our wake. We envy all whose blood we spill, for they are fortunate enough to find death.
                      ...
                      You will come to understand, in time, the glory that can be found in misery. You will feast your eyes on the magnificence of our sacrifice, the righteousness of our vengeance. And you will bow before the Shadowy Assassin Demonic Blade Slayer Super Ninjas, the true masters of death and despair.""",
              () -> {
