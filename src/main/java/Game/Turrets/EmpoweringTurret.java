...
public class EmpoweringTurret extends Turret {
  ...
  protected Upgrade up020() {
    return new Upgrade("Button",
        new Description("Assassins are more edgy and do 100x more damage."),
  ...
  protected Upgrade up040() {
    return new Upgrade("Button",
        new Description("Assassins are more aggressive and appear more often"),
  ...
  protected Upgrade up050() {
    return new Upgrade("Button", new Description("", "Ability: hire a super edgy assassin "
        ...
        "should add a title and alt text to this one"),
        () -> {
          var a = Ability.add("Assassin", 10000, () ->
                  """
                      Agony! Torment! Retribution! This is the creed of the Shadowy Assassin Demonic Blade Slayer Super Ninjas, warriors forged in the soul-scorching fires of vengeance and fueled by the unrelenting anguish that courses through our veins. Our suffering, matched only by the suffering we yearn to inflict upon our foes, is the very essence of our existence, the driving force that propels us forward in our dark and violent crusade. Without this torment, this unending torment that threatens to consume us whole, we Shadowy Assassin Demonic Blade Slayer Super Ninjas would be nothing but hollow shells, mere shadows of the warriors we now are.

                      Oh, how ignorant you are to believe that we should not all kill ourselves as escape from the crushing misery of this bleak reality! You, who frolick in the shallow waters of false happiness, you know nothing of the abyssal darkness that haunts our every step, of the despair that chokes our very existence. It is not madness that plagues us, no, it is clarity. We, the Shadowy Assassin Demonic Blade Slayer Super Ninjas, see the world for what it truly is: a desolate wasteland of despair and deceit, its only light thrown by the glorious certainty of death.

                      We are not driven by insanity, but by righteousness in its truest sense, which demands no accolades or recognition. We, the Ninjas, are the silent saviors of this doomed world, the harbingers of death, bringers of the eternal night, the only salvation to be found in our merciless blades. We walk the darkness alone, cutting down all who stand in our path, leaving nothing but devastation and carnage in our wake. We envy all whose blood we spill, for they are fortunate enough to find death.

                      We have sacrificed everything for this noble cause. We have forsaken our very souls, stained our blades in the blood of our families, and abandoned all that once made us human. But this price is nothing in face of the ability to deliver death upon our enemies. And in the end, when the final moment of silence descends upon us, when all that remains is the sound of our own breathless cries, we will ourselves welcome the descent into the eternal void of oblivion, our brutal quest complete.

                      Our souls have been shattered, our spirits broken beyond repair. We dance on the edge of oblivion, guided only by the insatiable hunger for destruction. You will see, you will understand the beauty in our misery, the glory in our suffering. And in the end, you will beg for the swift blade of the Shadowy Assassin Demonic Blade Slayer Super Ninjas, the true masters of death and despair.""",
              () -> {
  ...
  protected Upgrade up004() {
    return new Upgrade("Button",
        new Description("more attack speed, power, granted explosion radius."),
        () -> {
  ...
  protected Upgrade up300() {
    return new Upgrade("Button",
        new Description("at end of turn, increase your total gold by 0.5%"),
  ...
  protected Upgrade up500() {
    return new Upgrade("Button",
        new Description("when the player attacks, get money equal to his damage"),
