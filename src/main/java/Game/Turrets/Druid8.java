...
public class Druid8 extends Turret {
  ...
  private boolean root(TdMob mob){
    ...
    mob.addBuff(new StatBuff<TdMob>(Type.MORE,3000, TdMob.Stats.speed, 1/slow));
    ...
    mob.addBuff(new DelayedTrigger<TdMob>(3000, m->roots.delete(), true));
    return true;
  }
  ...
  protected Upgrade up100() {
    return new Upgrade("Button", new Description("bounces off walls"),
        () -> {
          ...
          bulletLauncher.addMobCollide((p,m)-> root(m));
        }, 200);
  }
