...
public class Engineer8 extends Turret {
  ...
  public void onGameTick(int tick) {
    ...
    turretPlaceTimer +=
        Game.tickIntervalMillis * stats[Stats.aspd] * stats[Engineer8.ExtraStats.spawnSpd];
  ...
  protected Upgrade up010() {
    return new Upgrade("turretmenu",
        new Description("turrets have an additional firing slit to shoot two projectiles at once"),
        () -> {
          turretMods.add(t -> {
  ...
  protected Upgrade up001() {
    return new Upgrade("spannermen",
        new Description("turrets are built faster and occasionally throws le spanner"),
        () -> {
