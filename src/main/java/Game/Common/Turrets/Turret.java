...
public abstract class Turret extends GameObject implements TickDetect {
  ...
  public final BulletLauncher bulletLauncher;
  ...
  public void removeBuff(Buff<Turret> b) {
    buffHandler.remove(b);
  }
  ...
  public float[] getColor16(){
    return sprite.getColors();
  }
  public void setColor16(float[] colors){
    sprite.setColors(colors);
  }
  public float[] getColor4(){
    float[] colors=sprite.getColors();
    float[] color4= {colors[0], colors[1], colors[2], colors[3]};
    return sprite.getColors();
  }
  public void setColor4(float[] colors){
    float[] colorFinal= new float[16];
    for (int a=0;a<4;a++){
      for (int b=0;b<4;b++) {
        colorFinal[b + a*4]=colors[b];
      }
    }
    sprite.setColors(colorFinal);
  }
